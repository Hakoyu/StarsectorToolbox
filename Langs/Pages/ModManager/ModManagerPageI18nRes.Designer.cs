...
namespace StarsectorToolbox.Langs.Pages.ModManager {
    ...
    public class ModManagerPageI18nRes {
        ...
        internal ModManagerPageI18nRes() {
        }
        ...
        ///再次载入位置: {1} 的本地化字符串。
        /// </summary>
        public static string ModIsContains {
            get {
                return ResourceManager.GetString("ModIsContains", resourceCulture);
            }
        }
        ...
        public static string ModIsContainsMessage {
            get {
                return ResourceManager.GetString("ModIsContainsMessage", resourceCulture);
            }
        }
